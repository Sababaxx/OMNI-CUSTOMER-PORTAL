...
const manageOffers = [
  {
    ...
    offerCopy: {
      ...
      body: "Switch to quarterly delivery for better per-order value, fewer billing cycles, and the same daily creatine routine. You can still skip, pause, or cancel from the portal anytime.",
  ...
  },
  {
    ...
    offerCopy: {
      ...
      body: "Add OMNI Creatine + Electrolytes stick packs to your next shipment. Great for hydration support around workouts or busy days.",
      bullets: ["Ships with your next subscription order", "Available in pear or peach", "No extra delivery fees — bundled in one box"],
      note: "Flavor and final pricing can be selected before checkout.",
    },
  },
];
...
const homeOffers = [
  ...
  },
  {
    ...
    offerCopy: {
      ...
      body: "Move to quarterly delivery for better value and fewer orders to manage.",
